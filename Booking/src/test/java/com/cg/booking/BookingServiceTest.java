...
public class BookingServiceTest {
	...
	public void testupdateBooking() {
		...
		String result = bookingService.updateBooking(getBooking(), 2);
	...
	public void testGetBooking() {
		...
		when(bookingRepository.findById(2)).thenReturn(getBookingOptional());
		Optional<Booking> result = bookingService.getBooking(2);
		assertNotNull(result);
	}
	...
	public void testGetBookingsByUserId() {
		...
		List<Booking> resultList =  bookingService.getBookingsByUserId("1234");
